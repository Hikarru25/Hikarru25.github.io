// Footer.jsx — Site footer + mobile bottom nav
// Desktop (>768px): email, social links, copyright
// Mobile (≤768px): same footer + fixed bottom icon nav bar
import { NavLink } from 'react-router-dom'
// Home, Briefcase, Link2, Mail come from lucide-react (generic utility icons ✅)
    ...
    <>
      <footer className={styles.footer}>
        <div className={styles.contact}>
          <a href="mailto:jenny@example.com" className={styles.email}>
            jenny@example.com
          </a>
          <div className={styles.socials}>
            <a
              href="https://github.com/Hikarru25"
              target="_blank"
      ...
      <nav className={styles.mobileNav} aria-label="Mobile navigation">
        {mobileNavLinks.map(({ to, icon, label, end }) => (
          <NavLink
            key={to}
            to={to}
            end={end}
